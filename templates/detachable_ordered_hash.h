...
#ifndef DETACHABLE_ORDERED_HASH_H
#define DETACHABLE_ORDERED_HASH_H
...
namespace Mechanika
{
	...
	#define MECHANIKA_DETACHABLE_ORDEREDHASH_NOCOPYASSIGN
	#include "detachable_ordered_hash_util.h"
	#undef MECHANIKA_DETACHABLE_ORDEREDHASH_NOCOPYASSIGN
}

#endif  /* DETACHABLE_ORDERED_HASH_H */
